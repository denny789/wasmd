...
func NewWasmApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	app.WasmKeeper = wasm.NewKeeper(appCodec, keys[wasm.StoreKey],
		app.getSubspace(wasm.ModuleName), app.AccountKeeper, app.BankKeeper, app.StakingKeeper,
	...
	testdata.RegisterTestServiceServer(app.GRPCQueryRouter(), testdata.TestServiceImpl{}) // TODO: this is testdata !!!!
