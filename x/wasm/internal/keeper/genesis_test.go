...
func setupKeeper(t *testing.T) (Keeper, sdk.Context, []sdk.StoreKey, func()) {
	...
	srcKeeper := NewKeeper(appCodec, keyWasm, pk.Subspace(wasmTypes.DefaultParamspace), authkeeper.AccountKeeper{}, nil, stakingkeeper.Keeper{}, nil, nil, capabilitykeeper.ScopedKeeper{}, nil, tempDir, wasmConfig, "", nil, nil)
